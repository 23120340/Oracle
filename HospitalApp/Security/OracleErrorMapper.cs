...
public static class OracleErrorMapper
{
    ...
    private static string FromOraNumber(int n, string original) => n switch
    {
        ...
        28003 => "Mật khẩu mới không đạt yêu cầu độ phức tạp của hệ thống.",
        28007 => "Mật khẩu mới không được trùng mật khẩu đã dùng trước đây.",
        28008 => "Mật khẩu hiện tại không đúng.",
